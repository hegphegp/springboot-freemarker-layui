  ...
  var settings = {}, roots = {}, caches = {},
    ...
    view = {
      ...
      makeDOMNodeMainBefore: function (html, setting, node) {
        html.push("<li id='", node.tId, "' class='", consts.className.LEVEL, node.level, "' tabindex='111' hidefocus='true' treenode>");
      },
      ...
      makeNodeIcoStyle: function (setting, node) {
        ...
        if (!node.isAjaxing) {
          ...
          if (icon) icoStyle.push("background:url(", icon, ") 111 111 no-repeat;");
